...
public class consts {
  ...
  public static final Identifier KILL_VEX = new Identifier(NAMESPACE, "kill_vex");
  public static final Identifier KILL_VEX_REWARD = new Identifier(NAMESPACE, "kill_vex_reward");
  public static final Identifier KILL_VEX_ACH = new Identifier(NAMESPACE, "adventure/kill_vex_ach");


  public static final Identifier SISYPHUS_SPAWNER_ID = new Identifier(NAMESPACE, "sisyphus_spawner");
